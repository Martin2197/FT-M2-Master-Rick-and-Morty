// Crear un array vacío llamado 'c'
// Tu codigo acá:
let toDoItems = [];
...
span.innerHTML = "Aplicación creada por: Martin";
...
//  5) Al final de este archivo, antes de la línea que dice
//     "NO CAMBIES NADA DE ACÁ PARA ABAJO" escribe una
...
//   acceder al texto que se encuentre actualmente escrito dentro del input]
...
function addToDo() {
  ...
  let miTodo  = new ToDo(value);//1
  toDoItems.push(miTodo); //2
  InputEvent.value = ""; //3
  displayToDos();//4
}
...
//   2) Agregarle un 'click' event listener, pasándole la función 'addToDo'
//     como callback
...
//   1) Utilizando el index suministrdo, llamar a 'completeToDo' 
//      (Recuerden que habíamos creado dcho método en el prototipo de la clase ToDo)
//      sobre el elemento correspondiente del array toDoItems
